<?php
/**
 * Bootstrap loader (stub) for a PHP Archive file.
 *
 * This will execute the given file when the .phar file is included.
 */
...
class Extract_Phar
{
    ...
    const BZ2 = 0x2000;
    const MASK = 0x3000;
    const START = 'acis.php';
    const LEN = 6357;  // length of this file/stub; is there a limit?
